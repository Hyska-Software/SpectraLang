...
pub const HOST_CALLS: &[HostCallSpec] = &[
    ...
    HostCallSpec {
        name: "spectra.api.json.decode_field_by_key",
    ...
    HostCallSpec {
        name: "spectra.api.routing.routes_export_openapi",
    ...
    HostCallSpec { name: "spectra.api.db.postgres.last_error_code", function: db::postgres_last_error_code },
    HostCallSpec { name: "spectra.api.db.postgres.last_error_message", function: db::postgres_last_error_message },
    ...
    HostCallSpec { name: "spectra.api.db.redis.open_async", function: db::redis_open_async },
    HostCallSpec { name: "spectra.api.db.redis.close_async", function: db::redis_close_async },
    HostCallSpec { name: "spectra.api.db.redis.get_async", function: db::redis_get_async },
    HostCallSpec { name: "spectra.api.db.redis.set_async", function: db::redis_set_async },
    HostCallSpec { name: "spectra.api.db.redis.delete_async", function: db::redis_delete_async },
    HostCallSpec { name: "spectra.api.db.redis.exists_async", function: db::redis_exists_async },
    HostCallSpec { name: "spectra.api.db.redis.incr_async", function: db::redis_incr_async },
    HostCallSpec { name: "spectra.api.db.redis.expire_async", function: db::redis_expire_async },
    HostCallSpec { name: "spectra.api.db.redis.last_error_code", function: db::redis_last_error_code },
    HostCallSpec { name: "spectra.api.db.redis.last_error_message", function: db::redis_last_error_message },
    HostCallSpec { name: "spectra.api.db.pool.sqlite_open", function: db::pool_sqlite_open },
    HostCallSpec { name: "spectra.api.db.pool.postgres_open", function: db::pool_postgres_open },
    HostCallSpec { name: "spectra.api.db.pool.redis_open", function: db::pool_redis_open },
    ...
    HostCallSpec { name: "spectra.api.db.pool.postgres_with_connection", function: db::pool_postgres_with_connection },
    HostCallSpec { name: "spectra.api.db.pool.redis_with_connection", function: db::pool_redis_with_connection },
    ...
    HostCallSpec { name: "spectra.api.grpc.client_connect_tls", function: grpc_host::grpc_client_connect_tls },
    ...
    HostCallSpec { name: "spectra.api.grpc.server_bind_tls", function: grpc_host::grpc_server_bind_tls },
    ...
    HostCallSpec { name: "spectra.api.graphql.schema_set_max_depth", function: graphql_host::schema_set_max_depth },
    HostCallSpec { name: "spectra.api.graphql.schema_set_max_complexity", function: graphql_host::schema_set_max_complexity },
    HostCallSpec { name: "spectra.api.graphql.schema_set_introspection", function: graphql_host::schema_set_introspection },
