...
pub(crate) fn lookup_std_api_host_function(
    ...
    match (module, function) {
        ...
        ("http3", "server_config_new") => Some(host_int("spectra.api.http3.server_config_new")),
        ("http3", "client_config_new") => Some(host_int("spectra.api.http3.client_config_new")),
        ("http3", "handler_text") => Some(host_int("spectra.api.http3.handler_text")),
        ("http3", "server_start") => Some(host_int("spectra.api.http3.server_start")),
        ("http3", "server_local_port") => Some(host_int("spectra.api.http3.server_local_port")),
        ("http3", "server_shutdown") => Some(host_task_int("spectra.api.http3.server_shutdown")),
        ...
        ("grpc", "message_len") => Some(host_int("spectra.api.grpc.message_len")),
        ("grpc", "message_free") => Some(host_bool("spectra.api.grpc.message_free")),
        ("grpc", "metadata_new") => Some(host_int("spectra.api.grpc.metadata_new")),
        ("grpc", "metadata_insert") => Some(host_bool("spectra.api.grpc.metadata_insert")),
        ("grpc", "metadata_append") => Some(host_bool("spectra.api.grpc.metadata_append")),
        ("grpc", "metadata_get") => Some(host_string("spectra.api.grpc.metadata_get")),
        ("grpc", "metadata_len") => Some(host_int("spectra.api.grpc.metadata_len")),
        ("grpc", "metadata_free") => Some(host_bool("spectra.api.grpc.metadata_free")),
        ...
        ("grpc", "response_metadata") => Some(host_int("spectra.api.grpc.response_metadata")),
        ...
        ("graphql", "execute") => Some(host_int("spectra.api.graphql.execute")),
        ("graphql", "execute_named") => Some(host_int("spectra.api.graphql.execute_named")),
        ("graphql", "execute_http") => Some(host_int("spectra.api.graphql.execute_http")),
