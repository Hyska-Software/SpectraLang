...
pub(crate) fn lookup_std_host_group_tensor_ml(
    module: &str,
    function: &str,
    ...
    match (module, function) {
        ...
        ("tensor", "deterministic_mode") => Some(host_int("spectra.std.tensor.deterministic_mode")),
        ...
        ("tensor", "stats_allocations") => Some(host_int("spectra.std.tensor.stats_allocations")),
        ...
        ("tensor", "stats_pool_misses") => Some(host_int("spectra.std.tensor.stats_pool_misses")),
        ("tensor", "stats_active_bytes") => Some(host_int("spectra.std.tensor.stats_active_bytes")),
        ...
        ("tensor", "stats_graph_nodes") => Some(host_int("spectra.std.tensor.stats_graph_nodes")),
        ...
        ("tensor", "set_grad_enabled") => Some(host_void("spectra.std.tensor.set_grad_enabled")),
        ...
        ("ml", "module_add_parameter") => Some(host_void("spectra.std.ml.module_add_parameter")),
        ("ml", "module_parameter_count") => Some(host_int("spectra.std.ml.module_parameter_count")),
        ...
        ("ml", "dataset_from_directory") => Some(host_int("spectra.std.ml.dataset_from_directory")),
        ...
        ("ml", "dataloader_batch_count") => Some(host_int("spectra.std.ml.dataloader_batch_count")),
        ...
        ("ml", "experiment_set_config") => Some(host_void("spectra.std.ml.experiment_set_config")),
        ("ml", "experiment_log_metric") => Some(host_void("spectra.std.ml.experiment_log_metric")),
        ...
        ("ml", "distributed_summary") => Some(host_string("spectra.std.ml.distributed_summary")),
        ("ml", "distributed_train_multithread") => {
            Some(host_int("spectra.std.ml.distributed_train_multithread"))
        }
        ("ml", "distributed_train_tcp") => Some(host_int("spectra.std.ml.distributed_train_tcp")),
        ("ml", "distributed_train_dataset_multithread") => Some(host_int(
        ...
        ("ml", "onnx_export_weights") => Some(host_string("spectra.std.ml.onnx_export_weights")),
        ("ml", "onnx_import_summary") => Some(host_string("spectra.std.ml.onnx_import_summary")),
        ...
        ("ml", "logits_sample_seeded") => Some(host_int("spectra.std.ml.logits_sample_seeded")),
        ...
        ("ml", "vector_index_persist") => Some(host_string("spectra.std.ml.vector_index_persist")),
        ...
        ("concurrent", "task_spawn_fn") => Some(host_int("spectra.std.concurrent.task_spawn_fn")),
        ...
        ("concurrent", "channel_close") => Some(host_void("spectra.std.concurrent.channel_close")),
        ...
        ("concurrent", "stats_channels") => Some(host_int("spectra.std.concurrent.stats_channels")),
        ...
        ("serve", "server_audit_log") => Some(host_string("spectra.std.serve.server_audit_log")),
        ...
        ("serve", "export_monitoring") => Some(host_string("spectra.std.serve.export_monitoring")),
        ("serve", "server_register_model_linear") => {
            Some(host_int("spectra.std.serve.server_register_model_linear"))
        }
        ("serve", "server_register_named_model_linear") => Some(host_int(
        ...
        ("serve", "server_register_named_model_onnx") => Some(host_int(
            "spectra.std.serve.server_register_named_model_onnx",
        )),
        ("serve", "server_infer") => Some(host_int("spectra.std.serve.server_infer")),
        ("serve", "server_result_vector") => {
            Some(host_int("spectra.std.serve.server_result_vector"))
        }
        ("serve", "http_start") => Some(host_int("spectra.std.serve.http_start")),
