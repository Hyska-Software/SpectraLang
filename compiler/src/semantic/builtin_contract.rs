...
pub const STD_API_PUBLIC_FUNCTIONS: &[(&str, &str)] = &[
    ...
    ("std.api.grpc.message_to_base64", "func(int) returns string"),
    ("std.api.grpc.message_len", "func(int) returns int"),
    ("std.api.grpc.message_free", "func(int) returns bool"),
    ("std.api.grpc.metadata_new", "func() returns int"),
    (
        "std.api.grpc.metadata_insert",
        "func(int, string, string) returns bool",
    ),
    (
    ...
    ("std.api.grpc.status_free", "func(int) returns bool"),
    ("std.api.grpc.response_message", "func(int) returns int"),
    ("std.api.grpc.response_status", "func(int) returns int"),
    ("std.api.grpc.response_metadata", "func(int) returns int"),
    ...
    (
        "std.api.grpc.client_client_streaming",
        "func(int, string, int, int, int) returns Task<int>",
    ),
    (
        "std.api.grpc.client_server_streaming",
        "func(int, string, int, int, int) returns Task<int>",
    ),
    (
    ...
    ("std.api.grpc.stream_free", "func(int) returns bool"),
    (
        "std.api.grpc.server_bind",
        "func(string, int, int, int, int) returns Task<int>",
    ),
    ("std.api.grpc.server_local_port", "func(int) returns int"),
    ("std.api.grpc.server_shutdown", "func(int) returns bool"),
    ("std.api.grpc.server_free", "func(int) returns bool"),
    ("std.api.graphql.schema_new", "func() returns int"),
    (
        "std.api.graphql.schema_set_workers",
        "func(int, int) returns bool",
    ),
    (
        "std.api.graphql.schema_set_subscription_capacity",
        "func(int, int) returns bool",
    ),
    (
        "std.api.graphql.schema_field_json",
        "func(int, int, string, string, string) returns bool",
    ),
    (
        "std.api.graphql.schema_field_callback",
        "func(int, int, string, string, int) returns bool",
    ),
    (
        "std.api.graphql.schema_subscription_json",
        "func(int, string, string, string) returns bool",
    ),
    (
        "std.api.graphql.schema_subscription_callback",
        "func(int, string, string, int) returns bool",
    ),
    ...
    (
        "std.api.graphql.execute_http",
        "func(int, int, string, string, string) returns int",
    ),
